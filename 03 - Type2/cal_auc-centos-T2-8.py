...
def showHISTandMsk(dataset):
    Fake_root = r'/data2/Jianwei-Fei/00-Dataset/01-Images/00-FF++/' + dataset + '/c23/val'
    ...
    for i in range(100):
        ...
        input = inputs.cuda()
        output1, output2,output3, output4,output5, output6,output7, output8 = net(input)
    ...
    plt.xlabel('mean')
    plt.ylabel('num')
    plt.savefig("res/df->" + dataset + "-c23-8.png")
    # plt.show()
