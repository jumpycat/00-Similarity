...
class DealDataset(Dataset):
    def __init__(self, loader=default_loader):
        ...
        fake_root = r'/data2/Jianwei-Fei/00-Dataset/01-Images/00-FF++/Deepfakes/c23/train/'
...
# Deepfakes Face2Face FaceSwap NeuralTextures
fake_root = r'/data2/Jianwei-Fei/00-Dataset/01-Images/00-FF++/Deepfakes/c23/val/'
