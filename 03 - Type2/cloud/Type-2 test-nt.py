...
class DealDataset(Dataset):
    def __init__(self, loader=default_loader):
        ...
        fake_root = r'/data2/Jianwei-Fei/00-Dataset/01-Images/00-FF++/NeuralTextures/raw/train/'
...
# Deepfakes Face2Face FaceSwap NeuralTextures
fake_root = r'/data2/Jianwei-Fei/00-Dataset/01-Images/00-FF++/NeuralTextures/raw/val/'
...
if __name__ == '__main__':
    for epoch in range(EPOCH):
        ...
        for i, data in enumerate(train_loader, 0):
            ...
            print(data)
            with open('runs/logs-nt-raw.txt', 'a', encoding='utf-8') as f:
                f.write(data)
                f.write('\n')

        best_acc, best_th = val(net)

        tag = 'nt-raw-epoch-%03d-loss-%.03f-ValAcc-%.03f-Threshold-%.03f' % (epoch + 1, loss.item(), best_acc, best_th)
        print(tag)
