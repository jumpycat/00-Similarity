...
dst_path = r'/data2/Jianwei-Fei/00-Dataset/00-Videos/00-FF++/'
target_root = r'/data2/Jianwei-Fei/00-Dataset/01-Images/00-FF++/'
...
def crop(video_path,type,split):
    ...
    while True:
        ...
        if not (success_df and success_f2f and success_fs and success_nt and success_df_msk and success_f2f_msk and success_fs_msk and success_nt_msk):
            break
        if i % gap == 0:
